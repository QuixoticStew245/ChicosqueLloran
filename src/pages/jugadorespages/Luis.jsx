...
import LuisImg from "../../assets/JugadoresFondo/LuisFondo.png";
...
const stats = [
    { nombre: "Goles", valor: 70, icon: <FaFutbol style={{ fontSize: "24px" }} /> },
    { nombre: "Asistencias", valor: 42, icon: <FaBullseye style={{ fontSize: "24px" }} /> },
    { nombre: "Tarjetas Amarillas", valor: 4, icon: <FaSquare style={{ color: "yellow", fontSize: "24px" }} /> },
...
const jugadores = [
    ...
    { nombre: "Santy", img: SantyImg, link: "/santyrch" },
            ...
            <main className="flex items-center justify-center w-full min-h-screen max-xl:flex-col gap-5 max-xl:!mt-20">
                ...
                <div className="w-full lg:w-1/2">
                    <section className="flex flex-col text-[#F5F5DC] gap-1 !mb-5 items-center xl:items-start text-center">
                        ...
                        <h2 className="text-6xl xl:text-8xl font-bold cursor-default">Luis GC</h2>
                    </section>
